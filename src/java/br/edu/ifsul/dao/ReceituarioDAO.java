...
public class ReceituarioDAO implements Serializable{
    ...
    private Receituario objetoSelecionado;// atributo que armazena o objeto que está sendo incluido/editado
    ...
    public List<Receituario> getLista(){
        ...
        return em.createQuery("from Receituario order by posologia").getResultList();
    }
    
    public boolean salvar(Receituario obj){
        try {
    ...
    public boolean remover(Receituario obj){
        try {
            em.getTransaction().begin();// inicia uma transação
    ...
    public Receituario localizar(Integer id){
        return em.find(Receituario.class, id);
    }

    public Receituario getObjetoSelecionado() {
        return objetoSelecionado;
    }

    public void setObjetoSelecionado(Receituario objetoSelecionado) {
